...
CodeEnhance is a framework for improving the security and quality of Python code generated by Large Language Models (LLMs). For this purpose, the framework leverages Static Application Security Testing (SAST) tools in an iterative refinement process that uses LLM-based self-correction and targeted fine-tuning. CodeEnhance is being developed by the [Cybersecurity Research Lab](https://www.jaist.ac.jp/is/labs/beuran-lab/) at Japan Advanced Institute of Science and Technology ([JAIST](https://www.jaist.ac.jp/english/)), Ishikawa, Japan.

The key features of CodeEnhance are:
...
The following diagram summarizes the two-stage workflow of CodeEnhance.
<p align="center">
  <img src="framework_overview.png" alt="CodeEnhance Framework Overview" width="700"/>
</p>
...
@misc{codeenhance2025,
  ...
  title = {{CodeEnhance}: {LLM}-Generated Python Code Enhacement Through SAST Integration and Fine-Tuning},
  year = {2025},
  howpublished = {\url{https://github.com/cyb3rlab/CodeEnhance}}
}
```
